...
```{r communitycompare, message=FALSE,error=FALSE, warning=FALSE, fig.height=15, fig.width=12}
library(dplyr)
library(ggplot2)
library(lubridate)
...
Comm1 <- "SUNNYSIDE" # enter 1st community
...
4. Interactive comparisons between communities, categories, years, etc. (similar to https://sharcz.shinyapps.io/financialforecastingtool/)
5. Model potential crime predictors (population size, aerial size, proximity to certain downtown, industrial parks, etc.)
6. **NOTE**: If you're interested in setting up a cloud version of RStudio using AWS, click on this link: http://strimas.com/r/rstudio-cloud-1/
